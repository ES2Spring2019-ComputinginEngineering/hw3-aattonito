...
#*****************************************
# YOUR NAME: Alyssa Attonito
# NUMBER OF HOURS TO COMPLETE: 1
# YOUR COLLABORATION STATEMENT(s): Grace helped me when I forgot a colon.
#
#
#*****************************************
...
while True:
    ...
    if (ship_X == asteroid_x) and (ship_Y == asteroid_y):  #Test to see if the ship has hit an asteroid
        ...
        # That is to say, that they have the same ship_X and ship_Y postion
